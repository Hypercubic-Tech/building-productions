      ...
      {/* pb-15 */}
        <div className="container">
          ...
          <div className="text-start fs-2 fw-bold text-muted mb-20 georgian">
            თუ ჩვენი ვებ- აპლიკაციის გამოყენება გსურთ,
            იხილეთ ქვემოთ მოცემული სატარიფო გეგმები,
            ამ გზით თქვენ შეძლებთ თქვენზე მორგებული
            სატარიფო გეგმის შეძენას და ჩვენი ვებ-აპლიკაციის გამოყენებას.
            <br/>
            ჩვენი პლატფორმის
