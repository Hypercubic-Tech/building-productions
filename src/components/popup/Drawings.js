...
const Drawings = ({ setSelect }) => {
    ...
    const [projectImgs, setProjectImgs] = useState([1,2,3,2,2,3,3]);
                        ...
                        <form id="kt_modal_add_user_form" className="form">
                            <span className="svg-icon svg-icon-2tx svg-icon-warning me-4 ">
                                {projectImgs && projectImgs.map((projectImg, index) => {
                                    return (
                                        <div className="image-input image-input-outline m-4" data-kt-image-input="true" key={index} >
                                            ...
                                            />
                                            :
                                            <div className="image-input-wrapper w-300px h-300px">{projectImg}</div>}
                                            <label
                                ...
                                <div className="image-input image-input-outline m-4" data-kt-image-input="true" >
                                            <div className="image-input-wrapper w-300px h-300px">new img</div>
                                            <label
                                                className="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow"
                                                data-kt-image-input-action="change"
                                                data-bs-toggle="tooltip"
