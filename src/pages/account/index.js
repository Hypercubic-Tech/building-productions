                        ...
                        <div className="text-center mb-3 image-input image-input-outline w-100">
                          ...
                          authUser[0]?.avatar[0]?.url ? (
                            ...
                            <div
                              ...
                              className="image-input-wrapper w-200px h-200px w-100"
                            ></div>
                          )}
                  ...
                  {session?.user && (
                    <div>
                      <div className="d-flex pt-3 pb-3">
                        ...
                        <div className="col-sm-6">{session.user?.name}</div>
                      </div>
                      <hr />
                      <div className="d-flex pt-3 pb-3">
                        <div className="col-sm-3">
                      ...
                      <div className="d-flex pt-3 pb-3">
                        ...
                        <div className="col-sm-6">{session.user?.email}</div>
                      </div>
                    </div>
                  )}
                  {isEdit && (
