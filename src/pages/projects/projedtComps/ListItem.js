...
import AddProductHandler from "./AddProductsForm";
...
const ListItem = () => {
    const [dataState, setDataState] = useState(productsData);
    const [select, setSelect] = useState(null);
    
    const pushTempArray = (newArr) => {
        return setDataState(oldData => [...oldData, newArr])
    }
                            ...
                            <div className="content flex-row-fluid" id="kt_content">
                                <div className="card">
                                            ...
                                            >
                                                <div className="modal-dialog modal-dialog-centered mw-650px">
                                                    <div className="modal-content">
                                                        ...
                                                        <div className="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                                            <AddProductHandler setSelect={setSelect} pushTempArray={pushTempArray} />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>}
                                    ...
                                    <div className="card-body pt-0">
                                        <Products ProductData={dataState} />
                                    </div>
                                </div>
                            </div>
                        </div>
